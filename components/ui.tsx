    ...
    >
      <span
        style={{
          width: 18,
          height: 1.5,
          background: "rgb(var(--content-brand))",
          borderRadius: 2,
        }}
      />
      {children}
...
type ButtonVariant = "brand" | "outline" | "ghost" | "inverse";
type ButtonSize = "sm" | "md" | "lg";

const SIZES: Record<ButtonSize, { height: number; padding: string; fontSize: number; radius: string }> = {
...
// ── ImageSlot — gradient placeholder; replace with <img src="..."> for real photos ──
...
export function ImageSlot({
  ...
  return (
    <div
      ...
      style={{ borderRadius: radius, width: "100%", height: "100%", ...style }}
    >
